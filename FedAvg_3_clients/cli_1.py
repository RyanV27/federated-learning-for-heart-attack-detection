...
def train_local_model(model, data_unhealthy_train, data_healthy_train, 
                        data_unhealthy_val, data_healthy_val, lr=1.0e-4, epochs=5, 
                            batch_size = 10):
    writer = SummaryWriter('/Users/Ryan/Desktop/Final Year Project/federated_learning/FedAvg_3_clients/runs/runs_cli' 
...
def run_client():
    ...
    #    client_socket.connect(('localhost', 8080))
        ...
        # *** Comment out the below three lines if running client for the first time *** 
        ...
        model = train_local_model(model, data_unhealthy_train, data_healthy_train, 
                                    data_unhealthy_val, data_healthy_val, lr=0.1, epochs=30001, 
                                        batch_size = 10)
