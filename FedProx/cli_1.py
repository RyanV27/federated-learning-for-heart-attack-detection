...
def train_local_model(model, data_unhealthy_train, data_healthy_train, 
                        data_unhealthy_val, data_healthy_val, mu = 0.01, max_grad_norm = 0, lr=1.0e-4, epochs=5, 
                            batch_size = 10):
    ...
    # Making a copy of model before training
...
def run_client():
    ...
    #    client_socket.connect(('localhost', 8080))
        ...
        # Proximity regularization parameter
        mu = 0.01
        ...
        model = train_local_model(model, data_unhealthy_train, data_healthy_train, 
                                    data_unhealthy_val, data_healthy_val, mu, max_grad_norm = 0, lr=0.1, epochs=30001, 
                                        batch_size = 10)
